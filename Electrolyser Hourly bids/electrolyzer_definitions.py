# electrolyzer_definitions.py where plant and storage characteristics are defined
...
TARGET_HYDROGEN_PER_DAY = 23760.0 # kg not used now was used duriing development, the target now comes from config.yaml
...
# --- The rest of the file populates globals based on the characteristics above
